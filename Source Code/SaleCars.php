...
$_SESSION['SaleCar'] = $_POST['hiddenvaluealso'];

echo '<script type="text/javascript">
           window.location = "SelectedCar.php"
      </script>';
	}
?>
<!DOCTYPE html>
...
<br>
			<h3> Choose from a variety of cars in this category . Whether you are looking for fuel-efficiency, space, or comfort and style you are sure to find the perfect car no matter where you are headed.</h3>
		</div>
...
<p class="beta" ><?php echo $value['CarName'] ?></p>
...
<div class="rate-normal" style="margin-top:10px;">Price:</div>
<div class="rate-uppertext">
</div>
</div>
</div>
...
<div class="rate-normal" style="margin-top:10px;"><b><?php echo $value['Price'] ?> $</b></div><div class="rate-uppertext">
</div>
</div>
...
<input type="submit" class="select-button" data-name="Economy" data-car="ECAR" id="ViewDet" Name="ViewDet"  value="View Details"> 
<input id="hiddenvaluealso" value="<?php echo $SaleCarID; ?>" type="hidden" name="hiddenvaluealso" />
